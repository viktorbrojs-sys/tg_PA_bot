...
Напишите боту любой текст — задача сразу появится в вашем markdown-файле как `- [ ] Текст`.
...
| Команда     | Действие                                            |
|-------------|------------------------------------------------------|
| Любой текст | Добавляет `- [ ] текст` в файл задач                 |
...
- Файл задач читается/пишется как обычный локальный файл: если вы деплоите
  бота в контейнер (например, на Replit), файл будет жить внутри контейнера
